module.exports = {
    ...
    config: {
        ...
        alias: ['pong', 'plob'],            // all these will trigger the run function aswell - optional
        ...
        showUsageOnError: false,             // Makes the bot message how to use the command correctly if you throw an exception
        category: 'Debug',                  // Decides where it will be listen in the help menue
        tags: ['Core', 'Debugging'],        // gives some tags in the help menue
        debugMode: true                     // If true the Module is only usable for the configured owners
                                            // and will show the Module and all its Commands debugmessages in the console
    }
};