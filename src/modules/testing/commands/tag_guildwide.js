module.exports = {
    ...
    config: function (bot) {
        return {
            ...
            description: 'Make awesome personal tags that everyone on the server can use!',
            // Gets shown in specific help and depening on setting (one below) if a command throws an error
            usage: `Create tags with: \`${bot.prefix}${this.config.cmd} create nameOfTheTag This is some cool text.\´\n` +
                   `Show a tag with: \`${bot.prefix}${this.config.cmd} nameOfTheTag\``,
